...
public class ChangePasswordManager extends AppCompatActivity {
            ...
            databaseReference.orderByChild("Email").equalTo(user.getEmail()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()) {
                        ...
                        if(pass.equals("")){
                            pd.dismiss();
                            Toast.makeText(ChangePasswordManager.this, "You Cannot Change Password", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            ...
                            databaseReference.child(user.getUid()).updateChildren(result)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            pd.dismiss();
                                            Toast.makeText(ChangePasswordManager.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            pd.dismiss();
                                            Toast.makeText(ChangePasswordManager.this, e.getMessage(), Toast.LENGTH_SHORT).show();

...
public class InfluencerVerificationCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_influencer_verification_code);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent=new Intent(InfluencerVerificationCode.this,InfluencerForgetPassword.class);
                            ...
                            Toast.makeText(InfluencerVerificationCode.this, "Entered InValid Code", Toast.LENGTH_SHORT).show();

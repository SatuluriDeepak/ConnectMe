...
public class AdapterInfluencerChatList extends RecyclerView.Adapter<AdapterInfluencerChatList.MyHolder> {
    ...
    public AdapterInfluencerChatList(Context context, List<ModelUser> userList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, final int i) {
        ...
        myHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(context, InfluencerChatAcitivity.class);

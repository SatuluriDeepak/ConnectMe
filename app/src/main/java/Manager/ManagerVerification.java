            ...
            databaseReference.orderByChild("Phone").equalTo(phone).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()) {
                        ...
                        if(pass.equals("")){
                            Toast.makeText(ManagerVerification.this, "You Cannot Change Password", Toast.LENGTH_SHORT).show();
                        }
                        else{
                        ...
                        Toast.makeText(ManagerVerification.this, "You Haven't Registered Phone Number", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new
            PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                    ...
                    Toast.makeText(ManagerVerification.this, "Code Send", Toast.LENGTH_SHORT).show();
                    Log.i("Sent",codeSent);
                    Intent intent=new Intent(ManagerVerification.this,ManagerVerificationCode.class);
    ...
    private void checkExits() {
        ...
        dbref.orderByChild("Phone").equalTo(phone).addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot){
                if(dataSnapshot.exists()) {
                    Toast.makeText(ManagerVerification.this, "Number already exists", Toast.LENGTH_SHORT).show();
                    f=0;
                }
                else{
                    f=1;

...
public class ManagerForgetPassword extends AppCompatActivity {
            ...
            databaseReference.child(id).updateChildren(result)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(ManagerForgetPassword.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                            mAuth.signOut();
                            updateUI(null);
                            Intent intent=new Intent(ManagerForgetPassword.this,ManagerLogin.class);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(ManagerForgetPassword.this, e.getMessage(), Toast.LENGTH_SHORT).show();
